...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('enquiry', '0026_auto_20210624_1159'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='enquiry',
            name='referrer',
            field=models.IntegerField(choices=[(0, 'Phone'), (1, 'Email'), (3, 'Web'), (6, 'Social'), (2, 'Calculator'), (5, 'Partner'), (4, 'Broker'), (7, 'Adviser'), (8, 'Pre Qualification'), (9, 'Search'), (100, 'Other')]),
        ),
    ]
