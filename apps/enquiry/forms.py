...
class EnquiryDetailForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['loanType', 'name', 'age_1', 'age_2', 'dwellingType', 'valuation', 'postcode',
                  'streetAddress', 'suburb', 'state',
                  'referrer', 'email', 'phoneNumber', 'enquiryNotes', 'referrerID', 'calcTotal',
        ...
        Div(
            ...
            Div(
                ...
                Div(Div(HTML("Valuation*"), css_class='form-label'),
                    Div(Field('valuation'))),
                Div(HTML("<br>")),
                Div(HTML("<i class='fas fa-search-dollar'></i>&nbsp;&nbsp;Requirements"),
                    css_class='form-header'),
                Div(
                    Div(HTML("Product Type"), css_class='form-label'),
                    Div(Field('productType'))),
                Div(
                    Div(HTML("Funding amount"), css_class='form-label'),
                    Div(Field('calcTotal'))),
