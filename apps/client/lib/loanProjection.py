...
class LoanProjection():
    ...
    def getProjections(self):
        ...
        for period in range(1,self.minProjectionPeriods):
            ...
            calcArray[period]['BOPHouseValue'] = calcArray[period-1]['BOPHouseValue']*(1 + self.aggDict['housePriceInflation']/100)
            calcArray[period]['BOPLoanValue'] = calcArray[period-1]['BOPLoanValue']*(1+self.totalInterestRate/100)
