...
class LixiXMLGenerator:
    ...
    def __init__(self,lixiSettings, productionData,submissionID, applicationID, commentStr, targetFilename):
        ...
        self.submit=ElementTree.SubElement(self.applicationInstructions, 'Submit',AssessmentType="Full", IsAccountVariation="No",IsResubmission="No")
        ...
        #-SchemaVersion
        self.schemaversion = ElementTree.SubElement(self.root, 'SchemaVersion', LIXITransactionType="CAL", LIXIVersion=self.LIXI_SETTINGS['LIXI_VERSION_CAL'])
    ...
    def populateElements(self, srcDict):
        ...
        try:
            ...
            self.detailedcomment=ElementTree.SubElement(self.application, 'DetailedComment',ContextDescription="Remoteness" )
            self.comment=ElementTree.SubElement(self.detailedcomment, 'Comment')
