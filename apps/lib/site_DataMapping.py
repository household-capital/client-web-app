...
def mapFacilityToCase(facilityObj):
    ...
    payload = {
        ...
        'loanType': loanTypesEnum.SINGLE_BORROWER.value if roleDict['number'] == 1 else loanTypesEnum.JOINT_BORROWER.value,
        ...
        'email_1': roleDict['borrowers'][0]['email'],
        'phoneNumber_1': roleDict['borrowers'][0]['mobile'] if roleDict['borrowers'][0]['mobile'] is not None else roleDict['borrowers'][0]['phone'],
...
def mapCaseToOpportunity(caseObj, lossObj):
    ...
    payload = {
        ...
        'phoneNumber': caseObj.phoneNumber_1,
        'email': caseObj.email_1,
